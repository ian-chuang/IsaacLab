...
create_parent_xforms(
    asset_usd_path="ur5_hybrid_sys.usd",
    source_prim_path="/world",
    save_as_path="ur5_hybrid_sys_xforms.usd",
)

convert_asset_instanceable(
    asset_usd_path="ur5_hybrid_sys_xforms.usd",
    source_prim_path="/world",
    save_as_path="ur5_hybrid_sys_instanceable.usd",
)
